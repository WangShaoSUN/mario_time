...
parser.add_argument('--games', type=str,default="SuperMarioBros-1-1-v0", help='name of the games. for example: Breakout')
...
PRED_PATH = './data/model_1/mvge_pped_o_1'+args.games+'.pkl'
TARGET_PATH = './data/model_1/mvg_target_net_o_1'+args.games+'.pkl'
...
dqn = DQN()
logdir = './MVG_DQN_time/%s' % args.games + '/%i' % int(time.time())
